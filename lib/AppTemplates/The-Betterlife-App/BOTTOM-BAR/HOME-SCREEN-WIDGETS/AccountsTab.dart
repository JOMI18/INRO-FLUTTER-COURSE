...
class _AccountState extends State<Account> {
  void copyToClipboard(String text) {
    // In Dart, the void keyword is used to indicate that a function does not return a value. It's typically used for functions that perform some actions but don't produce any result that needs to be returned.
    Clipboard.setData(ClipboardData(text: text));
    // Optionally, you can display a snackbar or toast to notify the user
