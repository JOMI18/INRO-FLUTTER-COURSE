import 'package:classapp/AppTemplates/Carbon/CUSTOMIZED/TabBars.dart';
import 'package:classapp/AppTemplates/Carbon/TRANSITION/ItemSlideIns.dart';
import 'package:flutter/material.dart';

class CarbonSavings extends StatefulWidget {
  CarbonSavings({super.key});

  @override
  State<CarbonSavings> createState() => _CarbonSavingsState();
}

class _CarbonSavingsState extends State<CarbonSavings> {
  int selectedIndex = 0;
    ...
    return Scaffold(
      body: Center(
        child: TabBarsViews(
          ...
          tabTitles: tabTitles,
          tabViews: [const Active(), Pending(), Completed()],
          onTabChanged: (index) {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: Color.fromARGB(255, 66, 34, 108),
              ),
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(255, 66, 34, 108),
